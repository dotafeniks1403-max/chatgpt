"""Generate bundled Serbian recordings at the voice's normal speaking rate."""
import asyncio, json
...
async def main():
    ...
    for i, text in enumerate(texts):
        ...
        for attempt in range(3):
            try:
                await edge_tts.Communicate(text, 'sr-RS-SophieNeural', rate='+0%', pitch='+0Hz').save(str(path))
